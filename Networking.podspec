...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "jswalsakshi" => "my@pers.on.al" }
  # Or just: spec.author    = "jswalsakshi"
  # spec.authors            = { "jswalsakshi" => "my@pers.on.al" }
  # spec.social_media_url   = "https://twitter.com/jswalsakshi"
